...
impl_stable_hash_for!(struct mir::MustCloneViolation { source_info, description, lint_node_id });
impl_stable_hash_for!(struct mir::MustCloneCheckResult { violations });
